...
export default function Inicio() {
    return (
                  ...
                  <div className="u-layout-row">
                    <div className="u-align-center-xs u-container-style u-custom-color-1 u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                      <div className="u-container-layout u-container-layout-1">
                        <h2 className="u-text u-text-white u-text-1">
                          Sobre nosotros.
                        </h2>
                        <p className="u-align-justify-lg u-align-justify-md u-align-justify-xl u-text u-text-2">
                          Banqueting Eventos y Catering es una empresa creada en el
                          año de 1993, con la finalidad de crear eventos sociales,
                          siendo el ámbito gastronómico la principal actividad,
                          proporcionando capital humano, mobiliario, venue,
                          ambientación, decoración, elementos de seguridad e higiene
                          a todos sus eventos, siendo miembro de la Cámara Nacional
                          de la Industria de Restaurantes y Alimentos Condimentados
                          CANIRAC y contando con la certificación del Sello de
                          Calidad “Punto Limpio” mismo que emite la Secretaría de
                          Turismo.
                        </p>
                        <img
                          src={cert2}
                    ...
                    <div className="u-align-center-md u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                      <div className="u-container-layout u-container-layout-2">
                        ...
                        />
                        <h4 className="u-align-center-lg u-align-center-xl u-text u-text-3">
                          MISION
                        </h4>
                        <p className="u-align-left-xl u-large-text u-text u-text-variant u-text-4">
                          Proporcionar banquetes de excelente calidad y servicio,
                          integrando los elementos necesarios para que el evento
                          cubra con las expectativas del cliente.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="u-size-30">
                  <div className="u-layout-row">
                    ...
                    <div className="u-align-center u-container-style u-custom-color-1 u-layout-cell u-size-15 u-size-30-md u-layout-cell-4">
                      <div className="u-container-layout u-valign-middle-lg u-valign-middle-xl u-valign-middle-xs u-container-layout-4">
                        <img
                          src={brujula}
                          alt = "vision"
                          ...
                          data-image-height={512}
                        />
                        <h4 className="u-text u-text-5">VISION</h4>
                        <p className="u-align-center-sm u-align-center-xs u-text u-text-6">
                          Ser la empresa líder de servicios gastronómicos y
                          organización de eventos, en el bajío, brindando nuestro
                          servicio altamente especializado en el área de Alimentos y
                          Bebidas.
                          <u />
                        </p>
                      </div>
                    ...
                    <div className="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xs u-container-style u-custom-color-1 u-layout-cell u-right-cell u-size-15 u-size-30-md u-layout-cell-5">
                      <div className="u-container-layout u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-container-layout-5">
                        ...
                        <h4 className="u-align-center-xl u-text u-text-7">
                          Valores
                        </h4>
                        <p className="u-align-center-xl u-text u-text-8">
                          Honestidad
                          <br />
                          Constancia&nbsp;
                          <br />
      ...
      <section
        className="u-clearfix u-palette-4-light-2 u-section-3"
        id="carousel_9e17"
      >
        <div className="u-clearfix u-sheet u-sheet-1">
              ...
              <div className="u-layout-col">
                    ...
                    <div className="u-align-right-xs u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                      <div className="u-container-layout u-valign-middle u-container-layout-2">
                        <h2 className="u-align-center-xs u-text u-text-1">
                          Expertos creadores de momentos inolvidables
                        </h2>
                        <p className="u-align-center-xs u-large-text u-text u-text-variant u-text-2">
                          En Banqueting creamos más que eventos creamos momentos
                          inolvidables.{" "}
                        </p>
                      </div>
                    </div>
                ...
                <div className="u-size-30">
                  <div className="u-layout-row">
                    ...
                    <div className="u-align-center u-container-style u-layout-cell u-palette-4-dark-1 u-right-cell u-size-15 u-size-30-md u-layout-cell-5">
                      <div className="u-container-layout u-valign-middle u-container-layout-5">
                        <h4 className="u-text u-text-3">BANQUETES</h4>
                        <p className="u-align-center-xs u-text u-text-4">
          ...
          <img
            className="u-expanded-width-xs u-image u-image-3"
            src={bn19}
          />
        </div>
      </section>
      <section
        className="u-align-center u-border-2 u-border-custom-color-2 u-clearfix u-custom-color-2 u-section-4"
        id="carousel_9f54"
      >
        <div className="u-clearfix u-sheet u-sheet-1">
          ...
          <div className="u-expanded-width u-list u-repeater u-list-1">
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-1">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-1">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                    viewBox="0 0 512 512"
            ...
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-2">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-2">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                  ...
                  <svg
                    ...
                    y="0px"
                    id="svg-35f7"
                    style={{ enableBackground: "new 0 0 480.187 480.187" }}
                  >
                    <g>
                      <g>
            ...
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-3">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-3">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
            ...
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-4">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-4">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
                    viewBox="0 0 512 512"
            ...
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-5">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-5">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
            ...
            <div className="u-align-center u-container-style u-list-item u-repeater-item">
              <div className="u-container-layout u-similar-container u-container-layout-6">
                <span className="u-align-left u-custom-color-1 u-icon u-icon-circle u-spacing-22 u-text-body-alt-color u-icon-6">
                  <svg
                    className="u-svg-link"
                    preserveAspectRatio="xMidYMin slice"
      ...
      <section
        className="u-clearfix u-palette-4-light-2 u-section-5"
        id="carousel_54b1"
      >
        <div className="u-clearfix u-sheet u-sheet-1">
          <div className="u-clearfix u-gutter-20 u-layout-wrap u-layout-wrap-1">
              ...
              <div className="u-layout-row">
                <div className="u-size-12 u-size-20-md">
                  <div className="u-layout-col">
                    <div className="u-size-30">
                      <div className="u-layout-row">
                        <div className="u-align-center u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-1">
                          <div className="u-container-layout u-valign-middle-sm u-valign-middle-xs u-container-layout-1">
                            <h1 className="u-align-center-xl u-text u-text-1">
                              Oferta
                              <br />
                              Gastronómica
                            </h1>
                    ...
                    <div className="u-size-30">
                      <div className="u-layout-row">
                        <div className="u-container-style u-layout-cell u-left-cell u-palette-4-dark-1 u-size-60 u-layout-cell-2">
                          <div className="u-container-layout u-container-layout-2" />
                        </div>
                      </div>
                    </div>
                ...
                <div className="u-size-24 u-size-40-md">
                  <div className="u-layout-col">
                    <div className="u-align-center u-container-style u-expand-resize u-layout-cell u-size-60 u-layout-cell-3">
                      <div className="u-container-layout">
                        <img
                          className="u-align-right-xs u-expanded-width u-image u-image-1"
                          src={bn30}
                          data-image-width={1280}
                          data-image-height={1280}
                        />
                        <h3 className="u-text u-text-2">
                          Tenemos el menú perfecto para acompañar tu evento
                        </h3>
                      </div>
                    </div>
                  </div>
                ...
                <div className="u-size-24 u-size-60-md">
                  <div className="u-layout-col">
                    <div className="u-size-30">
                      <div className="u-layout-row">
                        <div className="u-container-style u-layout-cell u-right-cell u-size-60 u-layout-cell-4">
                          <div className="u-container-layout">
                            <img
                              className="u-absolute-hcenter-md u-absolute-hcenter-sm u-absolute-hcenter-xs u-expand-resize u-expanded u-image u-image-2"
                              src={bn28}
                    ...
                    <div className="u-size-30">
                      <div className="u-layout-row">
                        ...
                        <div className="u-size-30">
                          <div className="u-layout-col">
                            <div
                              className="u-container-style u-image u-layout-cell u-right-cell u-size-60 u-image-4"
                              data-image-width={1280}
                              data-image-height={1280}
                            >
                              <div className="u-container-layout" />
      ...
      <section
        className="u-clearfix u-palette-4-base u-section-6"
        id="carousel_f6f1"
      >
        <div className="u-clearfix u-sheet u-sheet-1">
            ...
            <div className="u-layout">
              <div className="u-layout-row">
                <div className="u-align-left u-container-style u-layout-cell u-left-cell u-size-15 u-size-30-md u-layout-cell-1">
                  <div className="u-container-layout u-container-layout-1">
                    <h1 className="u-text u-text-1">Y mucho&nbsp;más...</h1>
                    <div className="u-border-20 u-border-palette-4-light-2 u-line u-line-horizontal u-line-1" />
                  </div>
                </div>
                ...
                <div className="u-align-center-xs u-container-style u-layout-cell u-right-cell u-size-15 u-size-30-md u-layout-cell-4">
                  <div className="u-container-layout u-valign-middle u-container-layout-4">
                    <p className="u-align-center-lg u-align-center-md u-align-center-sm u-align-center-xl u-text u-text-2">
